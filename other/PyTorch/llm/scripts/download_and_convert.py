...
def hf_download(model_repo: Optional[str] = None, hf_token: Optional[str] = None) -> None:
    ...
    if os.listdir(checkpoint_dir):
        ...
        try:
            snapshot_download(model_repo, local_dir=checkpoint_dir, local_dir_use_symlinks=False, token=hf_token,resume_download=True)
...
def convert_hf_checkpoint(
    *,
    ...
    weight_map_path: str = "D:\\workspaces\\python_projects\\PyTorch\\llm\\config\\weight_map.json",

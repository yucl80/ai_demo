...
def create_system_message(function_names: str, context: str) -> dict:
    ...
    4. If no predefined function is suitable, determine if the user's intent is to query information. If so, return "graph_query"; otherwise, return "help".
        ...
        if action_match and action_input_match:
            ...
            if action == "ask_user_info":
                ...
                if validate_result["result"]:
                    ...
                    continue
        elif response == "grpah_query":
            try:
                execute_graph_query(str)
